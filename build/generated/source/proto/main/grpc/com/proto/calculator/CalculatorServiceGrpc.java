...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.calculator.FindMaximumRequest,
      com.proto.calculator.FindMaximumResponse> getFindMaximunMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FindMaximun",
  ...
  public static io.grpc.MethodDescriptor<com.proto.calculator.FindMaximumRequest,
      com.proto.calculator.FindMaximumResponse> getFindMaximunMethod() {
    io.grpc.MethodDescriptor<com.proto.calculator.FindMaximumRequest, com.proto.calculator.FindMaximumResponse> getFindMaximunMethod;
    if ((getFindMaximunMethod = CalculatorServiceGrpc.getFindMaximunMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getFindMaximunMethod = CalculatorServiceGrpc.getFindMaximunMethod) == null) {
          CalculatorServiceGrpc.getFindMaximunMethod = getFindMaximunMethod = 
              ...
              .setFullMethodName(generateFullMethodName(
                  "calculator.CalculatorService", "FindMaximun"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.FindMaximumRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.FindMaximumResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CalculatorServiceMethodDescriptorSupplier("FindMaximun"))
                  .build();
          }
        }
     }
     return getFindMaximunMethod;
  }

  private static volatile io.grpc.MethodDescriptor<com.proto.calculator.SquareRootRequest,
      com.proto.calculator.SquareRootResponse> getSqureRootMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SqureRoot",
  ...
  public static io.grpc.MethodDescriptor<com.proto.calculator.SquareRootRequest,
      com.proto.calculator.SquareRootResponse> getSqureRootMethod() {
    io.grpc.MethodDescriptor<com.proto.calculator.SquareRootRequest, com.proto.calculator.SquareRootResponse> getSqureRootMethod;
    if ((getSqureRootMethod = CalculatorServiceGrpc.getSqureRootMethod) == null) {
      synchronized (CalculatorServiceGrpc.class) {
        if ((getSqureRootMethod = CalculatorServiceGrpc.getSqureRootMethod) == null) {
          CalculatorServiceGrpc.getSqureRootMethod = getSqureRootMethod = 
              io.grpc.MethodDescriptor.<com.proto.calculator.SquareRootRequest, com.proto.calculator.SquareRootResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "calculator.CalculatorService", "SqureRoot"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.SquareRootRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.calculator.SquareRootResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CalculatorServiceMethodDescriptorSupplier("SqureRoot"))
                  .build();
          }
        }
     }
     return getSqureRootMethod;
  }
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.proto.calculator.FindMaximumRequest> findMaximun(
        io.grpc.stub.StreamObserver<com.proto.calculator.FindMaximumResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getFindMaximunMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void squreRoot(com.proto.calculator.SquareRootRequest request,
        io.grpc.stub.StreamObserver<com.proto.calculator.SquareRootResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSqureRootMethod(), responseObserver);
    }
  ...
  public static final class CalculatorServiceStub extends io.grpc.stub.AbstractStub<CalculatorServiceStub> {
    ...
    public io.grpc.stub.StreamObserver<com.proto.calculator.FindMaximumRequest> findMaximun(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getFindMaximunMethod(), getCallOptions()), responseObserver);
    }
    ...
    public void squreRoot(com.proto.calculator.SquareRootRequest request,
        io.grpc.stub.StreamObserver<com.proto.calculator.SquareRootResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getSqureRootMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CalculatorServiceBlockingStub extends io.grpc.stub.AbstractStub<CalculatorServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.proto.calculator.SquareRootResponse squreRoot(com.proto.calculator.SquareRootRequest request) {
      return blockingUnaryCall(
          getChannel(), getSqureRootMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CalculatorServiceFutureStub extends io.grpc.stub.AbstractStub<CalculatorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.calculator.SquareRootResponse> squreRoot(
        com.proto.calculator.SquareRootRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getSqureRootMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_SUM = 0;
  private static final int METHODID_PRIME_NUMBER_DECOMPOSITION = 1;
  private static final int METHODID_SQURE_ROOT = 2;
  private static final int METHODID_COMPUTE_AVERAGE = 3;
  private static final int METHODID_FIND_MAXIMUN = 4;
      ...
      switch (methodId) {
        ...
        case METHODID_PRIME_NUMBER_DECOMPOSITION:
          serviceImpl.primeNumberDecomposition((com.proto.calculator.PrimeNumberDecompositionRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.calculator.PrimeNumberDecompositionResponse>) responseObserver);
          break;
        case METHODID_SQURE_ROOT:
          serviceImpl.squreRoot((com.proto.calculator.SquareRootRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.calculator.SquareRootResponse>) responseObserver);
          break;
        default:
      ...
      switch (methodId) {
        case METHODID_COMPUTE_AVERAGE:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.computeAverage(
              (io.grpc.stub.StreamObserver<com.proto.calculator.ComputeAverageResponse>) responseObserver);
        case METHODID_FIND_MAXIMUN:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.findMaximun(
              (io.grpc.stub.StreamObserver<com.proto.calculator.FindMaximumResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
      ...
      synchronized (CalculatorServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getFindMaximunMethod())
              .addMethod(getSqureRootMethod())
              .build();
        }
      }
    }
