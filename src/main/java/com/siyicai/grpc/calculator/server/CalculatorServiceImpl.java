package com.siyicai.grpc.calculator.server;
...
public class CalculatorServiceImpl extends CalculatorServiceGrpc.CalculatorServiceImplBase {
    ...
    @Override
    public StreamObserver<FindMaximumRequest> findMaximun(StreamObserver<FindMaximumResponse> responseObserver) {
    ...
    @Override
    public void squreRoot(SquareRootRequest request, StreamObserver<SquareRootResponse> responseObserver) {
        Integer number = request.getNumber();
